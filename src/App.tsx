...
export default function App () {
  ...
  return <>
    ...
    <footer className="site-footer wrap"><div><Link className="footer-name" to="/" aria-label="nporto.com, home"><img className="brand-logo" src="/brand/nporto-logo.png" width="40" height="44" alt="nporto.com" /></Link><p>Nick Portokallidis</p></div><nav aria-label="Footer navigation"><Link to="/work">Work</Link><Link to="/about">About</Link><Link to="/privacy">Privacy</Link><a href="https://2018.nporto.com/">Previous portfolio <span aria-hidden="true">↗</span></a><a href={contact.github}>GitHub <span aria-hidden="true">↗</span></a></nav></footer>
  </>;
}
