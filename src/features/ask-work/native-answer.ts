...
export async function answerWithNativeSession(baseSession: BrowserSession, question: string, results: SearchResult[], signal: AbortSignal, history: ChatExchange[]): Promise<GeneratedAnswer> {
